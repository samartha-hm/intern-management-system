    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: '1 1 260px' }}>
          ...
          >
            <QRCode value={checkInPayload} size={210} color="#022c22" icon="/icon-192.png" />
          </div>
        ...
        >
          <div style={{ fontSize: 44, fontWeight: 900, color: '#34d399', fontFamily: 'monospace', letterSpacing: 1.5, textShadow: '0 0 15px rgba(52,211,153,0.4)' }}>
